...
class RegisterView(generics.GenericAPIView):
    ...
    def post(self,request):
        ...
        email_body = 'Hey '+user.username+' Welcome On Board! \n We will be very pleased to serve you with our services. \n Use the below given link to verify your email... \n'+ absurl + '\n Please verify your account quickly the link gets invalid in 10 mins'
